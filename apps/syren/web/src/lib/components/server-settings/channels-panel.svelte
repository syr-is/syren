<script lang="ts">
	...
	import ChannelEditDialog from '$lib/components/channel-edit-dialog.svelte';
	import CreateChannelDialog from '$lib/components/create-channel-dialog.svelte';
	import ChannelPermissionEditor from '$lib/components/channel-permission-editor.svelte';
